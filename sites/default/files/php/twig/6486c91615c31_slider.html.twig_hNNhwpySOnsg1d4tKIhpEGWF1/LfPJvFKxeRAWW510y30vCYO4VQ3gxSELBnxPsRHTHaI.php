...
class __TwigTemplate_83a3ea58bc155f56da42ba33ef4d6d39 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"slider-text\">
      <ul class=\"js-rotating\">
        ...
        ";
            ...
            // line 10
            echo "        <li>
  \t\t\t\t<h1>Santha <em>FineArts</em></h1>
  \t\t\t\t<p>Experts in Handicrafts and Wood carvings. One of the best in Kerala.</p>
  \t\t\t\t<a class=\"button\" href=\"#\">Contact Us</a>
  \t\t\t</li>
  \t\t\t<li>
  \t\t\t\t<h1>Creativity <em>Beyond</em> Imagination</h1>
  \t\t\t\t<p>Preserving the rich traditional art, heritage and culture.</p>
  \t\t\t\t<a class=\"button\" href=\"#\">Buy Now</a>
  \t\t\t</li>
  \t\t\t<li>
  \t\t\t\t<h1>100% Satisfied Customers</h1>
  \t\t\t\t<p>We have high quality professionals with over 35 years of experience.</p>
...
";
    ...
    {
        return new Source("", "@xara/template-parts/slider.html.twig", "/home/user/public_html/demo-10/web/themes/custom/xara/templates/template-parts/slider.html.twig");
    }
